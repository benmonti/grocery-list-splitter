...
dotenv.config();
var PORT = import.meta.env.PORT || 3001;
var app = express();
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                if (!image) {
                    return [2 /*return*/, res.status(400).json({ error: "Missing image" })];
                }
                return [4 /*yield*/, getGeminiResponse(image)];
            case 1:
                text = _a.sent();
...
app.post("/api/proxy-generate", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var image, response, data, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
                ...
                return [4 /*yield*/, fetch("".concat(BACKEND_URL, "/api/generate"), {
                        method: "POST",
            ...
            case 3:
                err_1 = _a.sent();
                console.error("Error in /api/proxy-generate:", err_1);
                res.status(500).json({
